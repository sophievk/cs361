public class InstructionObject{
	...
	public InstructionObject(String action, String subject){
		setAction(action);
		setSubject(subject);
		setObject("");
		setVal(0);
	...
	public String toString(){
		if(action.equals("read") || action.equals("create") || action.equals("destroy")){
			return action + " " + sub + " " + obj + "\n";
		}
		else if(action.equals("write")){
			return action + " " + sub + " " + obj + " " + val + "\n";
		}
		return action + " " + sub + "\n";
	}
}